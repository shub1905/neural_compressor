...
class LogisticRegression(object):
    ...
    def cost(self, y):
        ...
        difference in actual value and predicted value of output
        emulating cost similar to hinge cost
        '''
...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, filter_shape, image_shape, poolsize=(2, 2),
                 pool_ignore_border=True, normal=False, std_normal=2):
        """
...
def train_nn(train_model, validate_model, test_model,
    ...
    return ((1 - best_validation_loss) * 100., (1 - test_score) * 100.)
